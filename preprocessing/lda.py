...
# -*- coding: utf-8 -*-
"""
Created on Sun Sep 23 13:11:49 2018
...
array_expand=array_expand.T
lca = LatentDirichletAllocation(n_components = num_com)
array_lca = lca.fit_transform(array_expand)

x = array_lca.reshape(145,145,8)
y0 = x[:,:,0]
y1 = x[:,:,1]
y2 = x[:,:,2]
y3 = x[:,:,3]
