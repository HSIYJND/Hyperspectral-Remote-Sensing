...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 19 12:15:51 2018
...
dataset = loadmat('/home/abhi/Documents/Hyper/Dataset_Hyperspectral/mat_files/Indian_pines.mat')
im=dataset['indian_pines']
'''
...
'''
gt1 = loadmat('/home/abhi/Documents/Hyper/Dataset_Hyperspectral/mat_files/Indian_pines_gt.mat')
gtr = (gt1['indian_pines_gt'])
...
pixels=im.reshape(indx[0]*indx[1],indx[2],order='F')
gt=gtr.reshape(indx[0]*indx[1],order='F')
